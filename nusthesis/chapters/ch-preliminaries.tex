...
wish to be part of; our objective is to identify partitions of parliament members
that satisfy certain desirable properties, such as stability.
...
which we describe in detail in Chapter~\ref{ch:hedonic}
