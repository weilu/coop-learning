...
\citename{ijcai2017-380} define that a class of hedonic games is PAC stablizable
...
In the same paper, \citename{ijcai2017-380} also show that top responsive games
