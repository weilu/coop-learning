...
With the addition of mutuality, as discussed in Section~\ref{subsec:stability},
...
stable parition and a PAC stable paritions in Subsection~\ref{subsec:algorithms},
...
\citename{Dimitrov2006} propose a similar algorithm for finding a strict core
...
Our improvement is based on \citename{Dimitrov2006}'s appreciation-of-friends
...
\citename{ijcai2017-380} already prove that their PAC algorithm efficiently PAC
