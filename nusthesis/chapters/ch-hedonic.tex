...
For the PAC version of the aversion to enemies models,
...
Step~\ref{pac_top_cover:sample_begin} to Step~\ref{pac_top_cover:sample_end}
...
of sampling and take intersection of these friend sets across multiple rounds
...
Step~\ref{bottom_responsive_core:select_begin} to
Step~\ref{bottom_responsive_core:select_end} to select a PAC stable coalition,
