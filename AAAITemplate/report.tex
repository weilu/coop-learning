...
Moreover, it also reveals a few politicians whose voting behaviors break from party lines. We also demonstrate empirically that PAC hedonic games compare favorably to $k$-clustering for uncovering voting patterns.
\end{abstract}
